...
namespace duckparser
{
  ...
  void press(const char *str, size_t len)
  {
    ...
    // Keys
      ...
      keyboard.pressKey(KEY_PROPS);
    else if (compare1(str, len, "DELETE", CASE_SENSETIVE))
      keyboard.pressKey(KEY_DELETE);
      ...
      keyboard.pressKey(KEY_PAUSE);
    else if (compare1(str, len, "CAPSLOCK", CASE_SENSETIVE))
      keyboard.pressKey(KEY_CAPSLOCK);
      ...
      keyboard.pressKey(KEY_SYSRQ);
    else if (compare1(str, len, "SCROLLLOCK", CASE_SENSETIVE))
      keyboard.pressKey(KEY_SCROLLLOCK);

    // NUMPAD KEYS
    else if (compare1(str, len, "NUM_0", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KP0);
    else if (compare1(str, len, "NUM_1", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KP1);
    else if (compare1(str, len, "NUM_2", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KP2);
    else if (compare1(str, len, "NUM_3", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KP3);
    else if (compare1(str, len, "NUM_4", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KP4);
    else if (compare1(str, len, "NUM_5", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KP5);
    else if (compare1(str, len, "NUM_6", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KP6);
    else if (compare1(str, len, "NUM_7", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KP7);
    else if (compare1(str, len, "NUM_8", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KP8);
    else if (compare1(str, len, "NUM_9", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KP9);
    else if (compare1(str, len, "NUM_ASTERIX", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KPASTERISK);
    else if (compare1(str, len, "NUM_ENTER", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KPENTER);
    else if (compare1(str, len, "NUM_MINUS", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KPMINUS);
    else if (compare1(str, len, "NUM_DOT", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KPDOT);
    else if (compare1(str, len, "NUM_PLUS", CASE_SENSETIVE))
      keyboard.pressKey(KEY_KPPLUS);

    // Consumer Control Buttons
    else if (compare1(str, len, "PLAYPAUSE", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_PLAY_PAUSE);
    else if (compare1(str, len, "STOP", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_STOP);
    else if (compare1(str, len, "NEXTTRACK", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_SCAN_NEXT);
    else if (compare1(str, len, "PREVTRACK", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_SCAN_PREVIOUS);
    else if (compare1(str, len, "VOLUME_MUTE", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_MUTE);
    else if (compare1(str, len, "VOLUME_UP", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_VOLUME_INCREMENT);
    else if (compare1(str, len, "VOLUME_DOWN", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_VOLUME_DECREMENT);
    else if (compare1(str, len, "BRIGHTNESS_UP", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_BRIGHTNESS_INCREMENT);
    else if (compare1(str, len, "BRIGHTNESS_DOWN", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_BRIGHTNESS_DECREMENT);

    else if (compare1(str, len, "SUSPEND", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_SLEEP);
    else if (compare1(str, len, "CALCULATOR", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_CALCULATOR);
    else if (compare1(str, len, "SEARCH", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_SEARCH);
    else if (compare1(str, len, "HOME", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_HOME);
    else if (compare1(str, len, "BACK", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_BACK);
    else if (compare1(str, len, "FORWARD", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_FORWARD);
    else if (compare1(str, len, "STOP", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_STOP);
    else if (compare1(str, len, "REFRESH", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_REFRESH);
    else if (compare1(str, len, "POWER", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_POWER);
    else if (compare1(str, len, "RESET", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_RESET);
    else if (compare1(str, len, "SLEEP", CASE_SENSETIVE))
      pressConsumer(CONSUMER_CONTROL_SLEEP);
    ...
    // Modifiers
      ...
      keyboard.pressModifier(KEY_MOD_LALT);
